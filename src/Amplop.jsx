  ...
  return (
    <div className="min-h-screen bg-[#030303] flex flex-col items-center justify-center relative overflow-hidden font-sans selection:bg-rose-500/30">
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center w-full h-full transition-all duration-[2000ms] ease-[cubic-bezier(0.87,0,0.13,1)] ${
        ...
        {/* Subtitle yang sudah diubah ke Happy Birthday dan lebih terang */}
        <p className="text-[#c9baba] text-[11px] sm:text-xs tracking-[0.6em] uppercase font-light mb-8 opacity-90 drop-shadow-md">
          Happy Birthday
        </p>

        {/* Nama (Tetap Mewah) */}
        <h1 className="text-5xl sm:text-7xl font-serif text-transparent bg-clip-text bg-gradient-to-b from-[#ffffff] via-[#f2e6e6] to-[#b39999] tracking-wide text-center mb-16 px-4 drop-shadow-lg">
          Tasya Septiani.
        </h1>

        {/* Tombol Unlock / Fingerprint Mewah yang lebih REALISTIS */}
        <div className="flex flex-col items-center">
          <button
            onClick={handleReveal}
            // Border diterangkan (white/30), Background diterangkan (white/10), ditambah shadow glow
          ...
          >
            ...
            {/* Icon Fingerprint lebih tebal (strokeWidth 1.2), lebih putih (90%), plus efek drop shadow */}
          ...
          {/* Teks "Tap to Unlock" diubah warnanya dari coklat gelap ke putih keabuan biar kontras */}
          <p className="mt-6 text-[#e5d5d5] text-[10px] sm:text-[11px] tracking-[0.4em] uppercase font-medium drop-shadow-md transition-colors duration-500">
